...
struct value_hfpHandleQacResponse_codecs
{
  uint16 codec;
};
struct region_hfpHandleQacResponse_codecs
{
  uint16 count;
  const uint8 *s;
  const uint8 *e;
...
struct value_hfpHandleQacResponse_codecs get_hfpHandleQacResponse_codecs(const struct region_hfpHandleQacResponse_codecs*, uint16);
...
struct hfpHandleQacResponse
{
  struct region_hfpHandleQacResponse_codecs codecs;
};
struct hfpHandleQcsNotification
{
  uint16 codec;
};
...
void hfpHandleQacResponse(Task , const struct hfpHandleQacResponse *);
void hfpHandleQcsNotification(Task , const struct hfpHandleQcsNotification *);
