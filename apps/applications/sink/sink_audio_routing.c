...
static void a2dpPreserveInitialAudio(Sink audio_sink)
{
...
static audio_instance_t ConnectWithParameters(audio_connect_parameters *connect_parameters)
{
    ...
    {
        if(connect_parameters->sink_type == AUDIO_SINK_AV)
        {
            a2dpPreserveInitialAudio(connect_parameters->audio_sink);
        }
    }
