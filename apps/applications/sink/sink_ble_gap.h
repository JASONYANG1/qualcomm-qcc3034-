...
typedef struct __ble_gap
{
    ...
    bool    slave_gatt_service_discovery_inprogress; /* Flag to indicate if slave GATT service discovery by BLE master is in progress */
#ifdef ENABLE_BROADCAST_AUDIO
...
/*******************************************************************************
NAME
    sinkBleGapIsSlaveGattServiceDiscoveryInProgress
    
DESCRIPTION
    Utility function to check if slave GATT service discovery is in progress by BLE Master
...
*/
#ifdef GATT_ENABLED
bool sinkBleGapIsSlaveGattServiceDiscoveryInProgress(void);
#else
#define sinkBleGapIsSlaveGattServiceDiscoveryInProgress() FALSE
#endif
