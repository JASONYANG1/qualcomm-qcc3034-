...
#include "sink_gatt_server_gaa_comm.h"
#endif
...
#ifdef GATT_GAA_MEDIA_SERVER
#include "sink_gatt_server_gaa_media.h"
#endif
...
#endif
#ifdef GATT_GAA_COMM_SERVER
    else if ( (id >= GATT_GAA_COMM_SERVER_MESSAGE_BASE) && (id < GATT_GAA_COMM_SERVER_MESSAGE_TOP))
    {
        sinkGattGaaCommServerMsgHandler(task, id, message);
    }
#endif
#ifdef GATT_AMS_PROXY
...
#ifdef GATT_GAA_COMM_SERVER
/* Connection update parameters if a GAA voice capture is in progress */
#define SINK_BLE_GAA_QUERY_CONN_PARAM_SLAVE_CONN_INTERVAL_MIN 12
#define SINK_BLE_GAA_QUERY_CONN_PARAM_SLAVE_CONN_INTERVAL_MAX 12
#define SINK_BLE_GAA_QUERY_PARAM_SLAVE_CONN_LATENCY           4
#define SINK_BLE_GAA_QUERY_PARAM_SUPERVISION_TIMEOUT          200
#define SINK_BLE_GAA_QUERY_PARAM_CE_LENGTH_MIN                0
#define SINK_BLE_GAA_QUERY_PARAM_CE_LENGTH_MAX                80

static const ble_connection_update_parameters_t ble_slave_update_conn_params_for_voice_capture =
{
    SINK_BLE_GAA_QUERY_CONN_PARAM_SLAVE_CONN_INTERVAL_MIN,            /* Minimum connection interval */
    SINK_BLE_GAA_QUERY_CONN_PARAM_SLAVE_CONN_INTERVAL_MAX,            /* Maximum connection interval */
    SINK_BLE_GAA_QUERY_PARAM_SLAVE_CONN_LATENCY,                      /* Connection latency */
    SINK_BLE_GAA_QUERY_PARAM_SUPERVISION_TIMEOUT,                     /* supervision timeout */
    SINK_BLE_GAA_QUERY_PARAM_CE_LENGTH_MIN,                           /* Minimum length of the connection */
    SINK_BLE_GAA_QUERY_PARAM_CE_LENGTH_MAX                            /* Maximum length of the connection */
};
